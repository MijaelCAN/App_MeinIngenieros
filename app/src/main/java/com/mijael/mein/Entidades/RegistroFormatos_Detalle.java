...
public class RegistroFormatos_Detalle implements Parcelable {
    ...
    public String il_7;
    public String il_8;
    public String puntos_med; //AGREGADO RECIENTEMENTE
    public String tipo_iluminacion; //AGREGADO RECIENTEMENTE
    ...
    private String id_tipo_medicion_ilu; //Agregado recientemente
    private String tipo_medicion_ilu; //aGREAGDO RECIENTEMENTE INICIAL
    ...
    private String num_min_pmedic; //Agregaro recientemente final
    public String temp;
    ...
    public RegistroFormatos_Detalle(){}
    ...
    public boolean isEstado_sincro() {
