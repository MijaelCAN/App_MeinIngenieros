...
public class Util_RegistroFormatos {
    ...
    public static final String CAMPO_LMAX_MD1 = "lequi_md1";
    public static final String CAMPO_LMAX_MD2 = "lequi_md2";
    public static final String CAMPO_LMAX_MD3 = "lequi_md3";
    public static final String CAMPO_LMAX_MD4 = "lequi_md4";
    public static final String CAMPO_LMAX_MD5 = "lequi_md5";
    public static final String CAMPO_LMIN_MD1 = "lequi_md1";
    public static final String CAMPO_LMIN_MD2 = "lequi_md2";
    public static final String CAMPO_LMIN_MD3 = "lequi_md3";
    public static final String CAMPO_LMIN_MD4 = "lequi_md4";
    public static final String CAMPO_LMIN_MD5 = "lequi_md5"; //Agregado recientemente Final
