...
public class RadiacionElec_Registro {
    ...
    public RadiacionElec_Registro(int id, String cod_formato, String id_formato, String id_plan_trabajo, String id_pt_formato, String id_equipo1, String cod_equipo1, String nom_equipo1,
