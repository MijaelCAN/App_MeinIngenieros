...
public class DAO_VelocidadAire {
    ...
    public boolean ActualizarVelocidad(VelocidadAire_Registro registro, int id_plan_trabajo_formato_reg){
        SQLiteDatabase db = helper.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public boolean ActualizarVelocidad_Detalle(VelocidadAire_RegistroDetalle registro,int id_formato_reg_detalle){
        SQLiteDatabase db = helper.getWritableDatabase();
        ContentValues values = new ContentValues();
