...
public class HumedadRelativa_Registro {
    ...
    public HumedadRelativa_Registro(int id, String cod_formato, String cod_registro, String id_formato, String id_plan_trabajo, String id_pt_formato, String id_equipo1,
