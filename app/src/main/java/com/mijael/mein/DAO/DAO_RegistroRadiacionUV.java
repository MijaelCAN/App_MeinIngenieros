...
public class DAO_RegistroRadiacionUV {
    ...
    public void ActualizarRadiacionUV(RadiacionUv_Registro registro, int id_plan_trabajo_formato_reg){
        SQLiteDatabase db = helper.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public void ActualizarRadiacionUv_Detalle(RadiacionUv_RegistroDetalle registro,int id_formato_reg_detalle){
        SQLiteDatabase db = helper.getWritableDatabase();
        ContentValues values = new ContentValues();
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String fecha = dateFormat.format(new Date());
